...
export class ReceiptsComponent implements OnInit {
  ...
  extraction: Array<Object> = [
    { name: 'Content.Extraction.NewProd', value: '1' },
    { name: 'Content.Extraction.Successives', value: '2' },
    { name: 'Content.Extraction.All', value: '3' },
    { name: 'Content.Extraction.Movements', value: '4' },
    { name: 'Content.Extraction.Suplements', value: '7' },
    { name: 'Content.Extraction.Rebate', value: '8' },
    { name: 'Content.Extraction.MonthCharges', value: '5' },
    { name: 'Content.Extraction.MonthEarrings', value: '6' },
  ];
  ...
  onSubmit({ value, valid }: { value, valid: boolean }) {
    ...
    this.dto.extractionType = value.content.extraction;
