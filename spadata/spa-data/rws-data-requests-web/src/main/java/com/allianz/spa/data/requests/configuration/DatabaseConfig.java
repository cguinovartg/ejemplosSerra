...
import com.allianz.spa.data.requests.configuration.AppConfig.DbConnection;
...
@EnableJpaRepositories(
	basePackages = "com.allianz.spa.data.requests.repository", 
	entityManagerFactoryRef = "entityManager", 
	transactionManagerRef = "transactionManager")
@Profile({ "database" })
public class DatabaseConfig {

	private static final String MODEL_PACKAGE = "com.allianz.spa.data.requests.model";
